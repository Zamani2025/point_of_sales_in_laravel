...
Route::get('/preview-coupons', [App\Http\Controllers\InvoiceController::class, 'coupons'])->name('coupons');
...
Route::post('/add-coupon',  [App\Http\Controllers\Coupon::class, 'store'])->middleware('auth')->name('addCoupon');
...
Route::post('/edit-coupon/{id}',  [App\Http\Controllers\Coupon::class, 'update'])->middleware('auth')->name('editcoupon');
Route::post('/delete-product/{id}',  [App\Http\Controllers\ProductController::class, 'destroy'])->middleware('auth')->name('deleteproduct');
Route::post('/delete-coupon/{id}',  [App\Http\Controllers\Coupon::class, 'destroy'])->middleware('auth')->name('deletecoupon');
...
Route::get('/coupon', [App\Http\Controllers\Coupon::class, 'index'])->middleware('auth')->name('customer');
...
Route::get('/transactions/{id}', [App\Http\Controllers\TransactionController::class, 'show'])->middleware('auth')->name('printtrans');
